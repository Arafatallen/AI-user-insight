  ...
  sections: [
    ...
    },
    {
      ...
      example: {
        ...
        comparison: [
          "项目启动狂 = 雄鸟建造精致的求偶亭，不断扩建新结构",
          "优化强迫症 = 花费数周精心装饰，用彩色石子排列图案",
          "完成度困难户 = 亭子本身无法居住，没有实用价值，纯为展示",
          "商业化问题 = 雌鸟看一眼就走，从不付费使用"
        ],
        coreIrony: "它以为自己在建房子，其实只是在搭舞台。",
        punchline: "一只不断优化求偶亭的园丁鸟，以为雌鸟会住进来，其实人家只是路过看看。"
      },
      inputs: ["behavior.longTermProjects", "stats.memorySpanDays", "persona.workPatterns", "behavior.topSkills"],
      outputFormat: { 
        archetype: "string (物种/物体名称)", 
        comparison: "string array (对比维度)",
        coreIrony: "string (一句话核心讽刺)",
        punchline: "string (结尾扎心句)"
      }
    },
    {
      name: "harshReality",
