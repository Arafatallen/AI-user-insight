...
const ANALYSIS_TEMPLATE_V1_HARSH = {
  ...
  sections: [
    ...
    },
    {
      ...
      options: [
        {
          archetype: "园丁鸟（Bowerbird）",
          matchCondition: "项目启动多+优化强迫症+完成度低+缺乏商业化",
          comparison: [
            "不断建新求偶亭 = 持续启动新项目",
            "精心装饰石子 = 优化非核心细节",
            "亭子无法居住 = 项目缺乏实用价值",
          ...
          coreIrony: "它以为自己在建房子，其实只是在搭舞台。",
          punchline: "一只不断优化求偶亭的园丁鸟，以为雌鸟会住进来，其实人家只是路过看看。"
        },
        {
        ...
        {
          archetype: "薛定谔的猫（Schrödinger's Cat）",
          matchCondition: "项目永远处于'即将完成'和'已经放弃'的叠加态",
          comparison: [
            "既死又活 = 项目既完成又未完成",
            "不打开箱子就不知道 = 不看代码以为是好的",
            "观察导致坍缩 = 一检查就发现bug",
          ...
          coreIrony: "它存在于所有状态的叠加中，唯独不存在于'完成'态。",
          punchline: "一只薛定谔的猫，在箱子里33天了——既没死透，也没出来，只是让你不断猜测。"
        },
        {
          archetype: "拼图收藏者（Puzzle Collector）",
          matchCondition: "囤积项目碎片+从不拼完+享受购买而非完成",
          comparison: [
            "买拼图不拼 = 启动项目不完成",
            "盒子堆满房间 = 仓库里全是半成品",
            "只看封面图 = 只享受想法不执行",
          ...
          coreIrony: "它享受的是'拥有拼图'的感觉，而非'完成拼图'的成就感。",
          punchline: "一个人买了33盒拼图，每盒都拼了一半——墙上挂着0幅成品，嘴里说着'我热爱拼图'。"
        },
        {
          archetype: "西西弗斯（Sisyphus）",
          matchCondition: "重复性工作+无意义的循环+永无止境的优化",
          comparison: [
            "推石上山 = 优化工作流",
            "石头滚下来 = 回到原点",
            "重复33次 = 同样的循环",
          ...
          coreIrony: "众神惩罚他重复无意义的劳动，而你是自己选择的。",
          punchline: "西西弗斯推了33天石头，每次到山顶都说'这次流程优化好了'——石头依然在谷底，他依然在山腰。"
        },
        {
